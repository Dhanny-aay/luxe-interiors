import table from '../image/wing.png'
import Image from 'next/image';

const Hero = () => {
    return ( 
        <>
        <div className=' flex w-full flex-col-reverse md:flex-row justify-center md:space-x-24 px-5 md:px-8 lg:px-12 items-center py-20 md:py-24 relative bg-[#f1f1f1]'>
            ...
            <div className=' absolute bottom-4 right-7 flex flex-row'>
                ...
                <button className=' font-normal text-base mt-5 pb-2 h-5 tracking-wide border-l border-black capitalize px-2'>Next</button>
            </div>
        </div>
        </>
     );

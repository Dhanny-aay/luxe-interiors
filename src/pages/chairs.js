...
if(typeof window !== "undefined"){
    ...
    return ( 
        ...
        <div className=" lg:pt-2 pb-3 py-5 px-5 md:px-12 items-center inline-flex space-x-3 ">
            <button className=" py-1 px-2  text-sm hover:bg-black hover:text-white border-black font-oswald border rounded-md tracking-wide">Accessories</button>
            <button className=" py-1 px-2 hover:bg-black hover:text-white text-sm border-black font-oswald border rounded-md tracking-wide">Stools</button>
            ...
            <button className=" py-1 px-2 bg-black text-white text-sm border-black font-oswald border rounded-md tracking-wide">Chairs</button>
        </div>
        <div className="">

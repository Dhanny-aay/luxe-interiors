...
const Tables = () => {
    ...
    const tableItems = useContext(TableContext);
    ...
    return ( 
        ...
        <div className=" lg:pt-2 pb-3 py-5 px-5 md:px-12 items-center inline-flex space-x-3 ">
            ...
            <button className=" py-1 px-2 bg-black text-white text-sm border-black font-oswald border rounded-md tracking-wide">Tables</button>
